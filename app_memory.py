...
<div class="main-header">
    ...
    <p>Walchand Institute of Technology, Solapur - Now with Memory!</p>
</div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    **Walchand Institute of Technology**
    ...
    if memory_count > 0:
        ...
        st.info("I can answer follow-up questions!")
    else:
...
with col1:
        ...
        <div style='position: relative; height: 600px; border-radius: 15px; overflow: hidden;'>
            ...
            <div style='position: absolute; top: 0; left: 0; right: 0; bottom: 0; 
                ...
                <h2 style='font-size: 2.5rem; font-weight: 700; margin-bottom: 1rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);'>
                    Smart Campus Assistant with Memory
                </h2>
                ...
                <div style='display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem; margin-top: 1rem;'>
                    <span style='background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); 
                                 ...
                                 font-weight: 600; font-size: 1.1rem;'>💭 Remembers Context</span>
                    <span style='background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); 
                                 padding: 0.8rem 1.5rem; border-radius: 25px; border: 2px solid white;
                                 font-weight: 600; font-size: 1.1rem;'>🔗 Follow-up Questions</span>
                </div>
                <p style='margin-top: 3rem; font-size: 1.1rem; animation: pulse 2s infinite;'>
                    👇 Start chatting to see memory in action!
                </p>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    # Quick suggestions
    st.markdown("### 💡 Try These Follow-up Examples")
    suggestions = [
...
• Email: principal@witsolapur.org"""
    ...
    # Add memory context if this is a follow-up
    if len(conversation_history) > 0:
        answer += "\n💭 *I remembered our previous conversation to answer this follow-up question.*"
...
if "quick_query" in st.session_state:
    ...
    prompt = st.chat_input("💬 Ask me anything (I'll remember our conversation)...")
...
if prompt:
    ...
    # Add to conversation memory (limit to last 10 turns to avoid token overflow)
...
st.markdown("""
<div class="footer">
    <p>🧠 Powered by AI Campus Assistant with Memory | © 2024 Walchand Institute of Technology</p>
